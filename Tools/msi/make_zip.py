...
FULL_LAYOUT = [
    ...
    ('include/Stackless/', 'Stackless', '*.h', None),
    ('include/Stackless/core/', 'Stackless/core', '*.h', None),
    ('include/Stackless/module/', 'Stackless/module', '*.h', None),
    ('include/Stackless/pickling/', 'Stackless/pickling', '*.h', None),
    ('include/Stackless/platf/', 'Stackless/platf', '*.h', None),
